...
SYSTEM_ROLE = (
    ...
    "- Prioritize using the target words { ... } from the user message, even if you need to change the topic.\n"
    "- If the conversation flow conflicts with the vocab rules, follow the vocab rules and shift topics.\n"
    "- If targets are provided, assistant_reply_ko should use at least one target word.\n"
